package com.example.contactutils.fragment
...
import com.example.contactutils.databinding.FragmentDialogBinding
...
class OutSideDialogFragment(val dismissed : (Boolean) -> Unit)  : DialogFragment()
    {
        ...
        fun newInstance(title: ContactListModel, dismissed : (Boolean) -> Unit): OutSideDialogFragment {
            val args = Bundle()
